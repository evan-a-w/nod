...
let%expect_test "alloc parses" =
  {|
alloc %ptr:ptr, (ptr, i64)
ret %ptr
|}
  |> test;
  [%expect
    ...
    ((root
      ((call_conv Default)
       (root
        ((~instrs_by_label
          ((%root
            ((Alloca ((dest ((name __gc_mask0) (type_ Ptr))) (size (Lit 8))))
             (Store (Lit 1)
              (Address ((base (Var ((name __gc_mask0) (type_ Ptr)))) (offset 0))))
             (Call (fn nod_gc_alloc) (results (((name ptr) (type_ Ptr))))
              (args ((Lit 16) (Var ((name __gc_mask0) (type_ Ptr))) (Lit 1))))
             (Return (Var ((name ptr) (type_ Ptr))))))))
         (~labels (%root))))
       (args ()) (name root) (prologue ()) (epilogue ())
       (bytes_for_clobber_saves 0) (bytes_for_padding 0) (bytes_for_spills 0)
       ...
       (root
        ((~instrs_by_label
          ((%root
            ((Alloca ((dest ((name ptr) (type_ Ptr))) (size (Lit 16))))
             (Load_field
              ((dest ((name hi) (type_ I64)))
               (base (Var ((name ptr) (type_ Ptr)))) (type_ (Tuple (I64 F64)))
               (indices (0))))
             (Load_field
              ((dest ((name lo) (type_ F64)))
               (base (Var ((name ptr) (type_ Ptr)))) (type_ (Tuple (I64 F64)))
               (indices (1))))
             (Store_field
              ((base (Var ((name ptr) (type_ Ptr))))
               (src (Var ((name lo) (type_ F64)))) (type_ (Tuple (I64 F64)))
               (indices (1))))
             (Memcpy
              ((dest (Var ((name ptr) (type_ Ptr))))
