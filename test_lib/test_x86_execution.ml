...
(* mov %y:f64, 3 *)
(* fsub %diff:f64, %x, %y *)
(* movq %result:i64, %diff *)
(* ret %result *)
(* |} *)
(*   in *)
(*   print_endline output; *)
(*   [%expect {| 4617878467915022336 |}] *)
(* ;; *)
...
(* mov %y:f64, 4 *)
(* fmul %prod:f64, %x, %y *)
(* movq %result:i64, %prod *)
(* ret %result *)
(* |} *)
(*   in *)
(*   print_endline output; *)
(*   [%expect {| 4623507967449235456 |}] *)
(* ;; *)
...
(* mov %y:f64, 4 *)
(* fdiv %quot:f64, %x, %y *)
(* movq %result:i64, %quot *)
(* ret %result *)
(* |} *)
(*   in *)
(*   print_endline output; *)
(*   [%expect {| 4617315517961601024 |}] *)
(* ;; *)
...
(*   let output = compile_and_execute {| *)
(* mov %f:f64, 3 *)
(* movq %i:i64, %f *)
(* ret %i *)
(* |} in *)
(*   print_endline output; *)
(*   [%expect {| 4613937818241073152 |}] *)
(* ;; *)
...
(* movq %result:i64, %product *)
(* ret %result *)
(* |} *)
(*   in *)
(*   print_endline output; *)
(*   [%expect {| 4623203049988087808 |}] *)
(* ;; *)
