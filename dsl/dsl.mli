...
val call5
  :  string
  -> ( 'a Atom.t * 'b Atom.t * 'c Atom.t * 'd Atom.t * 'e Atom.t
     , 'f Atom.t )
       Fn.t
  -> 'a Atom.t
  -> 'b Atom.t
...
module Instr : sig
  ...
  val fadd : dest:float64 Atom.t -> float64 Atom.t -> float64 Atom.t -> Block.t Ir0.t
  val fsub : dest:float64 Atom.t -> float64 Atom.t -> float64 Atom.t -> Block.t Ir0.t
  val fmul : dest:float64 Atom.t -> float64 Atom.t -> float64 Atom.t -> Block.t Ir0.t
  val fdiv : dest:float64 Atom.t -> float64 Atom.t -> float64 Atom.t -> Block.t Ir0.t
  ...
  val call : ('a, 'b) Fn.t -> Atom.t list -> results:Atom.t list -> Block.t Ir0.t
  val call0 : ('a, 'b) Fn.t -> Atom.t list -> Block.t Ir0.t
  val load_field
    :  ptr Atom.t
    -> Type.t
    -> int list
  ...
  val store_field : ptr Atom.t -> 'a Atom.t -> Type.t -> int list -> Block.t Ir0.t
